...
module.exports = {
    createPriest: function (req, res) {
        ...
        var priestData = {
            priestName: requestData.taskMessage,
            activeStatus: 'Y',
            createdAt: new Date(),
            updatedAt: new Date()
        };
        //inserting data into mysql
        connection.query('INSERT INTO Priest  SET ?', taskData, function (err, result, fields) {
            if (err) {
                console.log(err);
    ...
    getTask: function (req, res) {
        ...
        connection.query('SELECT * FROM Priest', function (err, result, fields) {
            if (err) {
                console.log(err);
